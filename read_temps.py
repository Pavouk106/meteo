...
while 1:
	...
	try:
		...
		temps_file_json.write('{ "Teplota bazénu": {"teplota": "%s"}, "Rozdíl teploty bazénu": {"teplota": "%s"}, "Vnější teplota (5cm)": {"teplota": "%s"} }' % (temps_values[0], round(temps_values[1]-temps_values[0], 3), temps_values[2]))
